...
public class UnweightedTransducer implements Transducer {
	...
	public class IndexTable {
		...
		public IndexTable(FileInputStream filestream, Integer indicesCount) throws java.io.IOException {
	...
	public class TransitionTable {
		...
		public TransitionTable(FileInputStream filestream, Integer transitionCount) throws java.io.IOException {
